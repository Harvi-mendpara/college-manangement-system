        ...
        <div class="main-home">
          ...
          <nav className="navbar">
            <ul className={toggleMenu ? "nav-links-mobile" : "nav-links"} onClick={() => setToggleMenu(false)}>
              ...
              <a href='#about'  className="item"><li>About</li></a>
              <a  href='#contact'  className="item"><li>Contact</li></a>
              <a  href='#footer' to="/event" className="item"><li>Event</li></a>
          ...
          <img className='image' src='https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHVuaXZlcnNpdHl8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60' />
